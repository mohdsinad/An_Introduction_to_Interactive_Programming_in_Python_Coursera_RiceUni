...
def new_game():
    global paddle1_pos, paddle2_pos, paddle1_vel, paddle2_vel  # these are values
    global score1, score2  # these are integer values
    global SIDE #this is a boolean vaues
